...
public enum ErrorHandler {
  JSON_PROCESSING_EXCEPTION(JsonProcessingException.class, "general_error"),
  NOT_FOUND_EXCEPTION(HttpClientErrorException.NotFound.class, "not_found_error_page"),
  BAD_REQUEST_EXCEPTION(HttpClientErrorException.BadRequest.class, "general_error"),
  UNAUTHORIZED_EXCEPTION(HttpClientErrorException.Unauthorized.class, "unauthorized_error"),
